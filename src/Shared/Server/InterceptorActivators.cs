...
/// <summary>
/// Provides caching and activation of gRPC interceptor activators.
/// </summary>
internal sealed class InterceptorActivators
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="InterceptorActivators"/> class.
    /// </summary>
    /// <param name="serviceProvider">The service provider used to resolve activators.</param>
    ...
    /// <summary>
    /// Gets the <see cref="IGrpcInterceptorActivator"/> for the specified interceptor type.
    /// </summary>
    /// <param name="type">The interceptor type.</param>
    /// <returns>The activator for the specified interceptor type.</returns>
