        ...
        private async Task<bool> MoveNextCore(CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                if (Current == null)
                {
                    ...
                    var status = GrpcProtocolHelpers.GetResponseStatus(_httpResponse, _call.Channel.OperatingSystem.IsBrowser, _call.Channel.HttpHandlerType == HttpHandlerType.WinHttp);
