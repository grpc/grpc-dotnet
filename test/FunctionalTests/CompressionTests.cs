...
namespace Grpc.AspNetCore.FunctionalTests
{
    ...
    public class CompressionTests : FunctionalTestBase
    {
        ...
        public async Task SendCompressedMessageWithIdentity_ReturnInternalError()
        {
            ...
            response.AssertStatus(StatusCode.Internal, "Request sent 'identity' grpc-encoding value with compressed message.");
        }
        ...
        public async Task SendCompressedMessageWithUnsupportedEncoding_ReturnUnimplemented()
        {
            ...
            response.AssertStatus(StatusCode.Unimplemented, "Unsupported grpc-encoding value 'DOES_NOT_EXIST'. Supported encodings: gzip");
        }
        ...
        public async Task SendCompressedMessageWithoutEncodingHeader_ServerErrorResponse()
        {
            ...
            // Assert
            Assert.AreEqual(HttpStatusCode.OK, response.StatusCode);
            response.AssertStatus(StatusCode.Internal, "Request did not include grpc-encoding value with compressed message.");
        }
